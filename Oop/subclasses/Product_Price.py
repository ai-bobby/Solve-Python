### developing operators for two lists in class 
# -------------------------------------------------------------------------------------
### two price lists of 10 products in two stores
## store 1
...
print(product3.__truediv__(2)) 
print(120*"*")
# ####################################################################
# # calculation of average prices (with a discount pricing strategy)

discount_List1 = product1.__mul__(0.20)
discount_List2 = product2.__mul__(0.20)
# # **************************************************
product4 = Product_Price(discount_List1)
product5 = Product_Price(discount_List2)
print(discount_List1)
print(discount_List2)
# # **************************************************
